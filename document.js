document.addEventListener('DOMContentLoaded', function () {
    ...
    //update the prompt and display output
    ...
    function executeCommand(command) {
        ...
        if (cmd === 'pic') {
            ...
            imageContainer.style.zIndex = '600' + imageContainer1;
            return 'Profile picture displayed.';
        }if (cmd === 'cv') {
            imageContainer1.style.display = 'flex';
            imageContainer1.style.zIndex = '' + imageContainer;
            return 'Profile picture displayed.';
        }
    ...
    closeButton.addEventListener('click', function () {
        imageContainer.style.zIndex = '100' + imageContainer1;
        imageContainer1.style.zIndex = '200' + imageContainer;
    });
});
